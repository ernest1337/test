...
<div class="container">
    <?php
//        if(gettype($_POST['stolb'])=='int' and gettype($_POST['strok'])=='int')
        if(filter_var($_POST['stolb'],FILTER_VALIDATE_INT) and filter_var($_POST['strok'], FILTER_VALIDATE_INT)
                    and 3<=$_POST['stolb'] and $_POST['stolb']<16
                    and 3<=$_POST['strok'] and $_POST['strok']<16) {
            ...
            echo "ВЫ НЕПРАВИЛЬНО ВВЕЛИ РАЗМЕР ТАБЛИЦЫ!!!" . "<br>" . "МИН 3x3 МАКС 15х15";
        }
    ?>
